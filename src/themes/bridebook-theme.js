...
import { colors as bridebookColors } from './variables';
import typography from './typography';

export const bridebookTheme: Theme = {
  typography: typography({
    fontSize: 16,
    fontSizeScale: 'step1', // perfect fourth, modularscale.com
    lineHeight: 18,
  }),
  colors: bridebookColors,
  page: {
